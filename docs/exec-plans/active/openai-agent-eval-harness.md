...
- Do not implement Claude, Gemini, or cloud GPU providers.
...
- Provider-neutral agent eval runner exists with fake and OpenAI providers.
...
3. Add fake provider support for deterministic tests and local validation.
4. Add CLI, shell wrapper, Make targets, and pyproject entrypoint.
5. Add tests for runner and CLI behavior.
6. Update docs with new commands and validation expectations.
7. Run harness validation, tests, deterministic evals, and fake-provider agent eval.
